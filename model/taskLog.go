...
type TaskLog struct {
	...
	Name      string    `gorm:"type:varchar(100);column:name"`   // 任务名称
	...
	StartTime time.Time `gorm:"type:datetime;column:start_time"` // 任务开始时间
	EndTime   time.Time `gorm:"type:datetime;column:end_time"`   // 任务结束时间
}
